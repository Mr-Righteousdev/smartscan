...
(1,'BAIT/21D/U/F0069','RFID_BAIT_21F_069',3,'entry','2025-11-12 14:42:56',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0',0,0,NULL,NULL),
(2,'BACS/21D/U/A0145','RFID_BACS_21A_145',3,'entry','2025-11-12 14:43:58',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0',0,0,NULL,NULL),
(3,'BAIT/22E/K/F0087','RFID_BAIT_22F_087',10,'entry','2025-11-12 14:44:28',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0',3,1,NULL,NULL);
...
(1,'Night Access Restriction','time_based',NULL,NULL,'22:00:00','06:00:00','monday,tuesday,wednesday,thursday,friday,saturday,sunday','medium','require_additional_auth',1,'2025-11-12 14:36:43',NULL),
(2,'Weekend Laboratory Access','time_based',NULL,NULL,'08:00:00','18:00:00','saturday,sunday','medium','allow',1,'2025-11-12 14:36:43',NULL),
(3,'Cybersecurity Lab Access Control','location_based',5,NULL,NULL,NULL,NULL,'medium','require_additional_auth',1,'2025-11-12 14:36:43',NULL),
(4,'ICT Office Access Control','location_based',10,NULL,NULL,NULL,NULL,'medium','require_additional_auth',1,'2025-11-12 14:36:43',NULL);
...
(1,'University Main Library','library','Library Complex','Ground','public',1,'2025-11-12 14:36:43'),
(2,'Digital Library & E-Resources','library','Library Complex','1st Floor','restricted',1,'2025-11-12 14:36:43'),
(3,'ICT Computer Laboratory 1','laboratory','School of Computing & IT','Ground','restricted',1,'2025-11-12 14:36:43'),
(4,'ICT Computer Laboratory 2','laboratory','School of Computing & IT','1st Floor','restricted',1,'2025-11-12 14:36:43'),
(5,'Cybersecurity & Innovation Lab','laboratory','School of Computing & IT','2nd Floor','restricted',1,'2025-11-12 14:36:43'),
(6,'Software Development Lab','laboratory','School of Computing & IT','2nd Floor','restricted',1,'2025-11-12 14:36:43'),
(7,'Nkumba Male Hostel','dormitory','Student Accommodation','Ground','restricted',1,'2025-11-12 14:36:43'),
(8,'Kigungu Female Hostel','dormitory','Student Accommodation','Ground','restricted',1,'2025-11-12 14:36:43'),
(9,'Main Lecture Theatre','lecture_hall','Academic Complex','Ground','public',1,'2025-11-12 14:36:43'),
(10,'ICT Department Lecture Hall','lecture_hall','School of Computing & IT','1st Floor','public',1,'2025-11-12 14:36:43'),
(11,'School of Computing & IT Office','admin','School of Computing & IT','3rd Floor','staff_only',1,'2025-11-12 14:36:43'),
(12,'Students Canteen','cafeteria','Student Life Center','Ground','public',1,'2025-11-12 14:36:43'),
(13,'University Sports Grounds','sports','Recreation Center','Ground','public',1,'2025-11-12 14:36:43'),
(14,'Administration Block','admin','Main Administration','Ground','staff_only',1,'2025-11-12 14:36:43'),
(15,'Student Affairs Office','admin','Student Life Center','1st Floor','public',1,'2025-11-12 14:36:43');
...
(1,'Database Encryption Key','data_at_rest','AES',256,'2025-11-12 14:36:43',NULL,1,1),
(2,'Session Token Key','session_management','HMAC-SHA256',256,'2025-11-12 14:36:43',NULL,1,1),
(3,'Card Data Encryption','card_information','AES',128,'2025-11-12 14:36:43',NULL,1,1);
...
(1,'BAIT/21D/U/F0069',3,'2025-11-12 14:42:56',0,'low','[]','allowed','2025-11-12 14:42:56'),
(2,'BACS/21D/U/A0145',3,'2025-11-12 14:43:58',0,'low','[]','allowed','2025-11-12 14:43:58'),
(3,'BAIT/22E/K/F0087',10,'2025-11-12 14:44:28',3,'medium','[\"high_security_location\"]','allowed','2025-11-12 14:44:28');
...
(1,'high_risk_access','medium',10,'BAIT/22E/K/F0087','RFID_BAIT_22F_087','High-risk access attempt by Otieno Michael requires additional verification','2025-11-12 14:44:28','new',NULL,NULL,NULL,NULL,NULL);
...
(1,'login_success','ENCRYPTED:Hfre nqzva ybttrq va fhpprffshyyl',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:38:07','low'),
(2,'logout','ENCRYPTED:Hfre nqzva ybttrq bhg',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:38:14','low'),
(3,'login_success','ENCRYPTED:Hfre nqzva ybttrq va fhpprffshyyl',1,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:41:23','low'),
(4,'access_attempt','ENCRYPTED:{\"npprff_ybt_vq\": 1, \"fghqrag_vq\": \"ONVG/21Q/H/S0069\", \"pneq_vq\": \"ESVQ_ONVG_21S_069\", \"ybpngvba_vq\": 3, \"npprff_glcr\": \"ragel\", \"tenagrq\": gehr, \"evfx_yriry\": \"ybj\", \"qravny_ernfba\": ahyy}',NULL,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:42:57','low'),
(5,'access_attempt','ENCRYPTED:{\"npprff_ybt_vq\": 2, \"fghqrag_vq\": \"ONPF/21Q/H/N0145\", \"pneq_vq\": \"ESVQ_ONPF_21N_145\", \"ybpngvba_vq\": 3, \"npprff_glcr\": \"ragel\", \"tenagrq\": gehr, \"evfx_yriry\": \"ybj\", \"qravny_ernfba\": ahyy}',NULL,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:43:58','low'),
(6,'access_attempt','ENCRYPTED:{\"npprff_ybt_vq\": 3, \"fghqrag_vq\": \"ONVG/22R/X/S0087\", \"pneq_vq\": \"ESVQ_ONVG_22S_087\", \"ybpngvba_vq\": 10, \"npprff_glcr\": \"ragel\", \"tenagrq\": gehr, \"evfx_yriry\": \"zrqvhz\", \"qravny_ernfba\": ahyy}',NULL,NULL,'127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:128.0) Gecko/20100101 Firefox/128.0','2025-11-12 14:44:28','low');
...
(1,'unauthorized_access','medium','new','Unknown Card Access Attempt','Multiple attempts to access secure locations using unregistered card ID',NULL,NULL,NULL,2,NULL,'2025-11-12 14:36:43',NULL,NULL,NULL,NULL,NULL),
(2,'suspicious_activity','high','new','Off-Hours Access Pattern','Student accessing multiple secure locations during restricted hours',NULL,NULL,NULL,2,NULL,'2025-11-12 14:36:43',NULL,NULL,NULL,NULL,NULL),
(3,'policy_violation','low','new','Tailgating Detected','Multiple card scans at same location within seconds',NULL,NULL,NULL,2,NULL,'2025-11-12 14:36:43',NULL,NULL,NULL,NULL,NULL);
...
('BACS/21D/U/A0145','RFID_BACS_21A_145','Atim Patricia','patim21@student.slau.ac.ug',NULL,'Bachelor of Computer Science',4,'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&h=150&fit=crop&crop=face','2025-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BACS/22D/U/A0024','RFID_BACS_22A_024','Nakato Sarah','snakato22@student.slau.ac.ug',NULL,'Bachelor of Computer Science',3,'https://images.unsplash.com/photo-1494790108755-2616b612b9e0?w=150&h=150&fit=crop&crop=face','2026-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BACS/23E/R/A0056','RFID_BACS_23A_056','Uwimana Eric','euwimana23@student.slau.ac.ug',NULL,'Bachelor of Computer Science',2,'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=150&h=150&fit=crop&crop=face','2027-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BAIT/21D/U/F0069','RFID_BAIT_21F_069','Mukasa David','dmukasa21@student.slau.ac.ug',NULL,'Bachelor of Information Technology',4,'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face','2025-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BAIT/22D/U/F0234','RFID_BAIT_22F_234','Namusoke Christine','cnamusoke22@student.slau.ac.ug',NULL,'Bachelor of Information Technology',3,'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&h=150&fit=crop&crop=face','2026-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BAIT/22E/K/F0087','RFID_BAIT_22F_087','Otieno Michael','motieno22@student.slau.ac.ug',NULL,'Bachelor of Information Technology',3,'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face','2026-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BAIT/23D/U/F0156','RFID_BAIT_23F_156','Ssemwogerere John','jssemwogerere23@student.slau.ac.ug',NULL,'Bachelor of Information Technology',2,'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face','2027-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BAIT/24D/U/F0003','RFID_BAIT_24F_003','Kiwanuka Robert','rkiwanuka24@student.slau.ac.ug',NULL,'Bachelor of Information Technology',1,'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&crop=face','2028-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BCSE/20D/U/A0012','RFID_BCSE_20A_012','Namugga Grace','gnamugga20@student.slau.ac.ug',NULL,'Bachelor of Computer Science & Engineering',5,'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face','2024-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43'),
('BCSE/23D/T/A0078','RFID_BCSE_23A_078','Mwalimu James','jmwalimu23@student.slau.ac.ug',NULL,'Bachelor of Computer Science & Engineering',2,'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=150&h=150&fit=crop&crop=face','2027-12-31','active','2025-11-12 14:36:43','2025-11-12 14:36:43');
...
(1,'max_failed_attempts','3','Maximum failed access attempts before triggering alert','2025-11-12 14:36:43',NULL),
(2,'alert_notification_email','security@slau.ac.ug','Email for security alerts','2025-11-12 14:36:43',NULL),
(3,'session_timeout_minutes','30','Dashboard session timeout in minutes','2025-11-12 14:36:43',NULL),
(4,'enable_real_time_alerts','true','Enable real-time alert notifications','2025-11-12 14:36:43',NULL),
(5,'card_expiry_warning_days','30','Days before card expiry to show warning','2025-11-12 14:36:43',NULL);
...
(1,'admin','admin@slau.ac.ug','admin_salt_123:8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918','System Administrator','admin','active','2025-11-12 14:41:23',0,NULL,0,NULL,'2025-11-12 14:36:43','2025-11-12 14:41:23',NULL),
(2,'security','security@slau.ac.ug','security_salt_456:ef92b778bafe771e89245b89ecbc08a44a4e166c06659911881f383d4473e94f','Security Officer','security_officer','active',NULL,0,NULL,0,NULL,'2025-11-12 14:36:43','2025-11-12 14:36:43',NULL),
(3,'john_doe','john.doe@staff.slau.ac.ug','staff_salt_789:5906ac361a137e2d286465cd6588ebb5ac3f5ae955001100bc41577c3d751764','John Doe Staff','staff','active',NULL,0,NULL,0,NULL,'2025-11-12 14:36:43','2025-11-12 14:36:43',NULL);
...
-- Dump completed on 2025-11-12 17:45:52
